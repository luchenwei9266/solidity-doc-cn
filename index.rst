...
译者说明：这是 **Solidity官方推荐中文版**，本文档根据当前 `Solidity官方文档 <https://solidity.readthedocs.io/>`_ v0.7.5 版本进行翻译，点击可前往 `Solidity中文文档最新版本 <https://learnblockchain.cn/docs/solidity/>`_  。
