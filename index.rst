...
译者说明：本文档根据当前 `Solidity官方文档 <https://solidity.readthedocs.io/>`_  0.6.12版本进行翻译，最新版本可前往 `Solidity中文文档最新版本 <https://learnblockchain.cn/docs/solidity/>`_ 。
